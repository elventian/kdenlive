...
QString ClipCreator::createIntervalClip(const std::shared_ptr<ProjectItemModel> &model)
{
    QDomDocument xml;

    createProducer(xml, ClipType::Color, "0xffffff00", "feature_binclip", 
        1, QStringLiteral("color"));
